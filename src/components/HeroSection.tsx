...
const HeroSection = () => {
  ...
  return (
    <section id="home" ref={heroRef} className="min-h-screen flex items-center justify-center bg-silk relative overflow-hidden">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <div ref={ctaRef}>
              <Button
                ...
                size="lg"
                className="spotlight-card bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 text-lg font-medium transition-all duration-300 hover:scale-105"
              >
